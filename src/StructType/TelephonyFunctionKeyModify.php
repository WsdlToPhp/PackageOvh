...
/**
 * This class stands for telephonyFunctionKeyModify StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyFunctionKeyModify extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyFunctionKeyModify::setSession()
     * @uses TelephonyFunctionKeyModify::setNumber()
     * @uses TelephonyFunctionKeyModify::setCountry()
     * @uses TelephonyFunctionKeyModify::setKeyNum()
     * @uses TelephonyFunctionKeyModify::setFunction()
     * @uses TelephonyFunctionKeyModify::setRelatedNumber()
