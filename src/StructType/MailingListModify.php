...
/**
 * This class stands for mailingListModify StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class MailingListModify extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses MailingListModify::setSession()
     * @uses MailingListModify::setDomain()
     * @uses MailingListModify::setMl()
     * @uses MailingListModify::setOwner()
     * @uses MailingListModify::setLang()
     * @uses MailingListModify::setReplyto()
     * @uses MailingListModify::setMessage_moderation()
     * @uses MailingListModify::setUsers_post_only()
     * @uses MailingListModify::setSubscription_moderation()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\MailingListModify
     */
