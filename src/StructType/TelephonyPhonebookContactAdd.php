...
/**
 * This class stands for telephonyPhonebookContactAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyPhonebookContactAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyPhonebookContactAdd::setSession()
     * @uses TelephonyPhonebookContactAdd::setNumber()
     * @uses TelephonyPhonebookContactAdd::setCountry()
     * @uses TelephonyPhonebookContactAdd::setId()
     * @uses TelephonyPhonebookContactAdd::setName()
     * @uses TelephonyPhonebookContactAdd::setSurname()
     * @uses TelephonyPhonebookContactAdd::setWorkPhone()
     * @uses TelephonyPhonebookContactAdd::setWorkMobile()
     * @uses TelephonyPhonebookContactAdd::setHomePhone()
     * @uses TelephonyPhonebookContactAdd::setHomeMobile()
     * @uses TelephonyPhonebookContactAdd::setGroup()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyPhonebookContactAdd
     */
