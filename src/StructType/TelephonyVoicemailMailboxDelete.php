...
class TelephonyVoicemailMailboxDelete extends AbstractStructBase
{
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyVoicemailMailboxDelete
     */
    ...
    public function setIds($ids = null)
    {
        ...
        if (!is_null($ids) && !is_string($ids)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($ids)), __LINE__);
        }
        $this->ids = $ids;
        return $this;
    }
