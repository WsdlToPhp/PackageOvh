...
/**
 * This class stands for accountSummaryReturn StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class AccountSummaryReturn extends AbstractStructBase
{
    /**
     * The nic
     * @var string
     ...
     * @uses AccountSummaryReturn::setNic()
     * @uses AccountSummaryReturn::setAccount()
     * @uses AccountSummaryReturn::setCountry()
     * @uses AccountSummaryReturn::setDescription()
     * @uses AccountSummaryReturn::setBalance()
     * @uses AccountSummaryReturn::setAlertThreshold()
     * @uses AccountSummaryReturn::setLimitThreshold()
     * @uses AccountSummaryReturn::setOpenDate()
     * @uses AccountSummaryReturn::setDate()
     * @uses AccountSummaryReturn::setCloseDate()
     * @param string $nic
