...
/**
 * This class stands for resellerDomainRestore StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class ResellerDomainRestore extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses ResellerDomainRestore::setSession()
     * @uses ResellerDomainRestore::setDomain()
     * @uses ResellerDomainRestore::setDryRun()
