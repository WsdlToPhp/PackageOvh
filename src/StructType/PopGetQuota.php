...
/**
 * This class stands for popGetQuota StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class PopGetQuota extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses PopGetQuota::setSession()
     * @uses PopGetQuota::setDomain()
     * @uses PopGetQuota::setPop()
