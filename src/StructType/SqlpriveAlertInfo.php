...
/**
 * This class stands for sqlpriveAlertInfo StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class SqlpriveAlertInfo extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses SqlpriveAlertInfo::setSession()
     * @uses SqlpriveAlertInfo::setServer()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\SqlpriveAlertInfo
     */
