...
/**
 * This class stands for dedicatedBackupGetHisto StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedBackupGetHisto extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedBackupGetHisto::setSession()
     * @uses DedicatedBackupGetHisto::setHostname()
     * @uses DedicatedBackupGetHisto::setBackupId()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\DedicatedBackupGetHisto
     */
