...
/**
 * This class stands for dedicatedBackupGetDate StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedBackupGetDate extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedBackupGetDate::setSession()
     * @uses DedicatedBackupGetDate::setHostname()
     * @uses DedicatedBackupGetDate::setBackupId()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\DedicatedBackupGetDate
     */
