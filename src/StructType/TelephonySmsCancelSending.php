...
/**
 * This class stands for telephonySmsCancelSending StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonySmsCancelSending extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonySmsCancelSending::setSession()
     * @uses TelephonySmsCancelSending::setSmsAccount()
