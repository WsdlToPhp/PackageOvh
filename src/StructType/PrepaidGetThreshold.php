...
/**
 * This class stands for prepaidGetThreshold StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class PrepaidGetThreshold extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses PrepaidGetThreshold::setSession()
     * @uses PrepaidGetThreshold::setNic()
