...
/**
 * This class stands for dedicatedBackupExcludeDel StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedBackupExcludeDel extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedBackupExcludeDel::setSession()
     * @uses DedicatedBackupExcludeDel::setHostname()
     * @uses DedicatedBackupExcludeDel::setBackupId()
     * @uses DedicatedBackupExcludeDel::setExclude()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\DedicatedBackupExcludeDel
     */
