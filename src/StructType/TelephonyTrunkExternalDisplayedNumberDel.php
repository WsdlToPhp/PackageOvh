...
/**
 * This class stands for telephonyTrunkExternalDisplayedNumberDel StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyTrunkExternalDisplayedNumberDel extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyTrunkExternalDisplayedNumberDel::setSession()
     * @uses TelephonyTrunkExternalDisplayedNumberDel::setNumber()
     * @uses TelephonyTrunkExternalDisplayedNumberDel::setCountry()
     * @uses TelephonyTrunkExternalDisplayedNumberDel::setExternalDisplayedNumber()
