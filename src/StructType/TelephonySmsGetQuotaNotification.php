...
/**
 * This class stands for telephonySmsGetQuotaNotification StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonySmsGetQuotaNotification extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonySmsGetQuotaNotification::setSession()
     * @uses TelephonySmsGetQuotaNotification::setSmsAccount()
     * @uses TelephonySmsGetQuotaNotification::setLogin()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonySmsGetQuotaNotification
     */
