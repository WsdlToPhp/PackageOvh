...
/**
 * This class stands for ripeCreateOrganisation StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class RipeCreateOrganisation extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses RipeCreateOrganisation::setSession()
     * @uses RipeCreateOrganisation::setName()
     * @uses RipeCreateOrganisation::setAddress()
     * @uses RipeCreateOrganisation::setEmail()
     * @uses RipeCreateOrganisation::setAbuse()
     * @uses RipeCreateOrganisation::setDescr()
     * @uses RipeCreateOrganisation::setPhone()
     * @uses RipeCreateOrganisation::setFax()
     * @uses RipeCreateOrganisation::setRemarks()
