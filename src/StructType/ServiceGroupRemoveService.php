...
/**
 * This class stands for serviceGroupRemoveService StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class ServiceGroupRemoveService extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses ServiceGroupRemoveService::setSession()
     * @uses ServiceGroupRemoveService::setName()
     * @uses ServiceGroupRemoveService::setService()
     * @uses ServiceGroupRemoveService::setComponent()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\ServiceGroupRemoveService
     */
