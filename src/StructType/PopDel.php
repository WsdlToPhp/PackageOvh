...
/**
 * This class stands for popDel StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class PopDel extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses PopDel::setSession()
     * @uses PopDel::setDomain()
     * @uses PopDel::setPop()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\PopDel
     */
