...
/**
 * This class stands for mailingListSubscriberAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class MailingListSubscriberAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses MailingListSubscriberAdd::setSession()
     * @uses MailingListSubscriberAdd::setDomain()
     * @uses MailingListSubscriberAdd::setMl()
     * @uses MailingListSubscriberAdd::setEmail()
