...
/**
 * This class stands for telephonyLineList StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyLineList extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyLineList::setSession()
     * @uses TelephonyLineList::setBillingAccount()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyLineList
     */
