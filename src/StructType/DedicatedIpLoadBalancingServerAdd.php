...
/**
 * This class stands for dedicatedIpLoadBalancingServerAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedIpLoadBalancingServerAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedIpLoadBalancingServerAdd::setSession()
     * @uses DedicatedIpLoadBalancingServerAdd::setIpLoadBalancing()
     * @uses DedicatedIpLoadBalancingServerAdd::setHostname()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\DedicatedIpLoadBalancingServerAdd
     */
