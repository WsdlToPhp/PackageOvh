...
/**
 * This class stands for sqlpriveMysqlProcessList StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class SqlpriveMysqlProcessList extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses SqlpriveMysqlProcessList::setSession()
     * @uses SqlpriveMysqlProcessList::setServer()
