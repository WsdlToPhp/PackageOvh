...
/**
 * This class stands for telephonyFMHuntingModificationMode StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyFMHuntingModificationMode extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyFMHuntingModificationMode::setSession()
     * @uses TelephonyFMHuntingModificationMode::setNumber()
     * @uses TelephonyFMHuntingModificationMode::setCountry()
     * @uses TelephonyFMHuntingModificationMode::setBillingAccount()
     * @uses TelephonyFMHuntingModificationMode::setStrategy()
     * @uses TelephonyFMHuntingModificationMode::setPattern()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyFMHuntingModificationMode
     */
