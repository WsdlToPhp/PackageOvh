...
/**
 * This class stands for telephonyVoicemailMailboxList StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyVoicemailMailboxList extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyVoicemailMailboxList::setSession()
     * @uses TelephonyVoicemailMailboxList::setNumber()
     * @uses TelephonyVoicemailMailboxList::setCountry()
     * @uses TelephonyVoicemailMailboxList::setPagingStart()
     * @uses TelephonyVoicemailMailboxList::setPagingLimit()
     * @uses TelephonyVoicemailMailboxList::setSortField()
     * @uses TelephonyVoicemailMailboxList::setSortOrder()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyVoicemailMailboxList
     */
