...
/**
 * This class stands for infrastructureReverseModify StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class InfrastructureReverseModify extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses InfrastructureReverseModify::setSession()
     * @uses InfrastructureReverseModify::setHostname()
     * @uses InfrastructureReverseModify::setIp()
     * @uses InfrastructureReverseModify::setReverse()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\InfrastructureReverseModify
     */
