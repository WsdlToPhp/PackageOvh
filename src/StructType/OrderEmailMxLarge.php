...
/**
 * This class stands for orderEmailMxLarge StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class OrderEmailMxLarge extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses OrderEmailMxLarge::setSession()
     * @uses OrderEmailMxLarge::setDomain()
     * @uses OrderEmailMxLarge::setType()
     * @uses OrderEmailMxLarge::setPayWithPoints()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\OrderEmailMxLarge
     */
