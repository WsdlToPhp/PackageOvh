...
class ResellerDomainCreate extends AbstractStructBase
{
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\ResellerDomainCreate
     */
    ...
    public function setSsl($ssl = null)
    {
        ...
        if (!is_null($ssl) && !is_string($ssl)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($ssl)), __LINE__);
        }
        $this->ssl = $ssl;
        return $this;
    }
    ...
    public function setSslDomainList($sslDomainList = null)
    {
        ...
        if (!is_null($sslDomainList) && !is_string($sslDomainList)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($sslDomainList)), __LINE__);
        }
    ...
    public function setCdn($cdn = null)
    {
        ...
        if (!is_null($cdn) && !is_string($cdn)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($cdn)), __LINE__);
        }
        $this->cdn = $cdn;
        return $this;
    }
