...
/**
 * This class stands for telephonyDdiInfoReturn StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyDdiInfoReturn extends AbstractStructBase
{
    /**
     * The number
     * @var string
     ...
     * @uses TelephonyDdiInfoReturn::setNumber()
     * @uses TelephonyDdiInfoReturn::setCountry()
     * @uses TelephonyDdiInfoReturn::setNoReplyTimer()
     * @uses TelephonyDdiInfoReturn::setLogged()
     * @param string $number
