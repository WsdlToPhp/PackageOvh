...
/**
 * This class stands for ripeUpdateOrganisation StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class RipeUpdateOrganisation extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses RipeUpdateOrganisation::setSession()
     * @uses RipeUpdateOrganisation::setRipeId()
     * @uses RipeUpdateOrganisation::setName()
     * @uses RipeUpdateOrganisation::setAddress()
     * @uses RipeUpdateOrganisation::setEmail()
     * @uses RipeUpdateOrganisation::setAbuse()
     * @uses RipeUpdateOrganisation::setDescr()
     * @uses RipeUpdateOrganisation::setPhone()
     * @uses RipeUpdateOrganisation::setFax()
     * @uses RipeUpdateOrganisation::setRemarks()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\RipeUpdateOrganisation
     */
