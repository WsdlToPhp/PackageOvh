...
/**
 * This class stands for multiDomainAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class MultiDomainAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses MultiDomainAdd::setSession()
     * @uses MultiDomainAdd::setDomain()
     * @uses MultiDomainAdd::setMultidomain()
     * @uses MultiDomainAdd::setTarget()
     * @uses MultiDomainAdd::setCountry()
     * @uses MultiDomainAdd::setOwnLog()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\MultiDomainAdd
     */
