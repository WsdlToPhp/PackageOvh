...
/**
 * This class stands for dedicatedReverseInfoResponse StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedReverseInfoResponse extends AbstractStructBase
{
    /**
     * The return
     * @var string
     ...
     * @uses DedicatedReverseInfoResponse::setReturn()
     * @param string $return
     */
