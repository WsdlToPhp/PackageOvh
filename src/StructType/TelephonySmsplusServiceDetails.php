...
/**
 * This class stands for telephonySmsplusServiceDetails StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonySmsplusServiceDetails extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonySmsplusServiceDetails::setSession()
     * @uses TelephonySmsplusServiceDetails::setShortCode()
     * @uses TelephonySmsplusServiceDetails::setKeyword()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonySmsplusServiceDetails
     */
