...
/**
 * This class stands for dedicatedFilterIrcClientRuleDel StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedFilterIrcClientRuleDel extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedFilterIrcClientRuleDel::setSession()
     * @uses DedicatedFilterIrcClientRuleDel::setHostname()
     * @uses DedicatedFilterIrcClientRuleDel::setFromIp()
     * @uses DedicatedFilterIrcClientRuleDel::setToIp()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\DedicatedFilterIrcClientRuleDel
     */
