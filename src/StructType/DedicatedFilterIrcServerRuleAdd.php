...
/**
 * This class stands for dedicatedFilterIrcServerRuleAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class DedicatedFilterIrcServerRuleAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses DedicatedFilterIrcServerRuleAdd::setSession()
     * @uses DedicatedFilterIrcServerRuleAdd::setHostname()
     * @uses DedicatedFilterIrcServerRuleAdd::setToIp()
