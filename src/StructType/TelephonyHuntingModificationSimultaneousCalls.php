...
/**
 * This class stands for telephonyHuntingModificationSimultaneousCalls StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyHuntingModificationSimultaneousCalls extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyHuntingModificationSimultaneousCalls::setSession()
     * @uses TelephonyHuntingModificationSimultaneousCalls::setNumber()
     * @uses TelephonyHuntingModificationSimultaneousCalls::setCountry()
     * @uses TelephonyHuntingModificationSimultaneousCalls::setBillingAccount()
     * @uses TelephonyHuntingModificationSimultaneousCalls::setNumberOfCalls()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\TelephonyHuntingModificationSimultaneousCalls
     */
