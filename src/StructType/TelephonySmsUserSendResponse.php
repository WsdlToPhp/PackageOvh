...
/**
 * This class stands for telephonySmsUserSendResponse StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonySmsUserSendResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int
     ...
     * @uses TelephonySmsUserSendResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \PayPal\StructType\TelephonySmsUserSendResponse
     */
