...
/**
 * This class stands for responderEmailModify StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class ResponderEmailModify extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses ResponderEmailModify::setSession()
     * @uses ResponderEmailModify::setDomain()
     * @uses ResponderEmailModify::setResponder()
     * @uses ResponderEmailModify::setContent()
     * @uses ResponderEmailModify::setDelivered_to()
     * @uses ResponderEmailModify::setNic()
     ...
     * Set session value
     * @param string $session
     * @return \PayPal\StructType\ResponderEmailModify
     */
