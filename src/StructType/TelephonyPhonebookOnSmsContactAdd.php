...
/**
 * This class stands for telephonyPhonebookOnSmsContactAdd StructType
 * @subpackage Structs
 * @author WsdlToPhp <contact@wsdltophp.com>
 */
class TelephonyPhonebookOnSmsContactAdd extends AbstractStructBase
{
    /**
     * The session
     ...
     * @uses TelephonyPhonebookOnSmsContactAdd::setSession()
     * @uses TelephonyPhonebookOnSmsContactAdd::setSmsAccount()
     * @uses TelephonyPhonebookOnSmsContactAdd::setId()
     * @uses TelephonyPhonebookOnSmsContactAdd::setName()
     * @uses TelephonyPhonebookOnSmsContactAdd::setSurname()
     * @uses TelephonyPhonebookOnSmsContactAdd::setWorkPhone()
     * @uses TelephonyPhonebookOnSmsContactAdd::setWorkMobile()
     * @uses TelephonyPhonebookOnSmsContactAdd::setHomePhone()
     * @uses TelephonyPhonebookOnSmsContactAdd::setHomeMobile()
     * @uses TelephonyPhonebookOnSmsContactAdd::setGroupName()
