...
class TelephonySmsUserMultiSend extends AbstractStructBase
{
     ...
     * @param bool $noStop
     */
    public function __construct($login = null, $password = null, $smsAccount = null, $numberFrom = null, \PayPal\ArrayType\MyArrayOfStringType $numberTo = null, $message = null, $smsValidity = null, $smsClass = null, $smsDeferred = null, $smsPriority = null, $smsCoding = null, $tag = null, $numberToCsv = null, $noStop = null)
    {
        $this
            ->setLogin($login)
     ...
     * Set login value
     * @param string $login
     * @return \PayPal\StructType\TelephonySmsUserMultiSend
     */
