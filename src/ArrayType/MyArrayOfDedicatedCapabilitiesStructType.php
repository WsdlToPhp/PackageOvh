...
class MyArrayOfDedicatedCapabilitiesStructType extends AbstractStructArrayBase
{
    ...
    public function setItem(array $item = array())
    {
        foreach ($item as $myArrayOfDedicatedCapabilitiesStructTypeItemItem) {
            ...
            if (!$myArrayOfDedicatedCapabilitiesStructTypeItemItem instanceof \Ovh\StructType\DedicatedCapabilitiesStruct) {
                throw new \InvalidArgumentException(sprintf('The item property can only contain items of \Ovh\StructType\DedicatedCapabilitiesStruct, "%s" given', is_object($myArrayOfDedicatedCapabilitiesStructTypeItemItem) ? get_class($myArrayOfDedicatedCapabilitiesStructTypeItemItem) : gettype($myArrayOfDedicatedCapabilitiesStructTypeItemItem)), __LINE__);
            }
        }
        $this->item = $item;
        return $this;
    ...
    public function addToItem(\Ovh\StructType\DedicatedCapabilitiesStruct $item)
    {
        ...
        if (!$item instanceof \Ovh\StructType\DedicatedCapabilitiesStruct) {
            throw new \InvalidArgumentException(sprintf('The item property can only contain items of \Ovh\StructType\DedicatedCapabilitiesStruct, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->item[] = $item;
        return $this;
    }
