...
class MyArrayOfSupportThreadMessageDetailStructType extends AbstractStructArrayBase
{
    ...
    public function setItem(array $item = array())
    {
        foreach ($item as $myArrayOfSupportThreadMessageDetailStructTypeItemItem) {
            ...
            if (!$myArrayOfSupportThreadMessageDetailStructTypeItemItem instanceof \Ovh\StructType\SupportThreadMessageDetailStruct) {
                throw new \InvalidArgumentException(sprintf('The item property can only contain items of \Ovh\StructType\SupportThreadMessageDetailStruct, "%s" given', is_object($myArrayOfSupportThreadMessageDetailStructTypeItemItem) ? get_class($myArrayOfSupportThreadMessageDetailStructTypeItemItem) : gettype($myArrayOfSupportThreadMessageDetailStructTypeItemItem)), __LINE__);
            }
        }
        $this->item = $item;
        return $this;
    ...
    public function addToItem(\Ovh\StructType\SupportThreadMessageDetailStruct $item)
    {
        ...
        if (!$item instanceof \Ovh\StructType\SupportThreadMessageDetailStruct) {
            throw new \InvalidArgumentException(sprintf('The item property can only contain items of \Ovh\StructType\SupportThreadMessageDetailStruct, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->item[] = $item;
        return $this;
    }
